...
CONFIG_LABELS = {
    ...
    "freeze_backbone_proj_blocks0-3": "Freeze backbone+proj+blocks 0-3",
    "freeze_backbone_proj_blocks0-5": "Freeze backbone+proj+blocks 0-5",
    "freeze_backbone_proj_blocks0-8": "Freeze backbone+proj+blocks 0-8",
    "freeze_backbone_proj_blocks0-11": "Freeze backbone+proj+blocks 0-11",
